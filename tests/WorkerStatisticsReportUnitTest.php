...
class WorkerStatisticsReportUnitTest extends TestCase
{
    ...
    /**
     * Functional test for Worker Statistics Report listing
     * 
     * @return void
     */
    public function testForWorkerStatisticsReportUnitTestListing(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/reports/workerStatistics/list', ["search" => "", "page" => 1, "export" => 0], $this->getHeader(false));
    ...
    /**
     * Functional test for Worker Statistics Report listing search
     * 
     * @return void
     */
    public function testForWorkerStatisticsReportUnitTestListingSearch(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/reports/workerStatistics/list', ["search" => "test", "page" => 1, "export" => 0], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' =>
                [
    ...
    /**
     * Functional test for Worker Statistics Report listing export
     * 
     * @return void
     */
    public function testForWorkerStatisticsReportUnitTestListingExport(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/reports/workerStatistics/list', ["search" => "", "page" => 1, "export" => 1], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' =>
                [
