...
class PostArrivalStatusUpdateUnitTest extends TestCase
{
    ...
    public function testForPostArrivalFlightNumberFormatValidation(): void
    {
     ...
     /**
     * Functional test for post arrival, postponed remarks required validation 
     * 
     * @return void
     */
    public function testForPostArrivalPostponedRemarksValidation(): void
    {
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/arrival/updatePostponed', array_merge($this->postponedData(), ['remarks' => '']), $this->getHeader());
        $response->seeStatusCode(422);
        $response->seeJson([
            'data' => [
    ...
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/arrival/workersListExport', ['application_id' => 1, 'onboarding_country_id' => 1, 'search' => 'Wo', 'filter' => ''], $this->getHeader(false));
        $response->seeStatusCode(422);
        $response->seeJson([
            'data' => [
                'search' => ['The search must be at least 3 characters.']
    ...
    /**
     * Functional test for export worker list with search
     * 
     * @return void
     */
    public function testForWorkersListForExportWithSearch(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/arrival/workersListExport', ['application_id' => 1, 'onboarding_country_id' => 1, 'search' => 'Wor', 'filter' => ''], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' =>
                [
    ...
    /**
     * Functional test for export worker list with filter
     * 
     * @return void
     */
    public function testForWorkersListForExportWithfilter(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/arrival/workersListExport', ['application_id' => 1, 'onboarding_country_id' => 1, 'search' => '', 'filter' => Carbon::now()->format('Y-m-d')], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' =>
                [
    ...
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/arrival/workersListExport', ['application_id' => 1, 'onboarding_country_id' => 1, 'search' => '', 'filter' => ''], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' =>
                [
     ...
     * @return void
     */
    public function testForPostArrivalStatusList(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/postArrivalStatusList', ['application_id' => 1, 'onboarding_country_id' => 1], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' =>
                [
    ...
    {
        return ['application_id' => 1, 'onboarding_country_id' => 1, 'arrived_date' => Carbon::now()->format('Y-m-d'), 'entry_visa_valid_until' => Carbon::now()->addYear()->format('Y-m-d'), 'workers' => [1]];
    }
    /**
     * @return array
     */
    ...
    {
        return ['application_id' => 1, 'onboarding_country_id' => 1, 'jtk_submitted_on' => Carbon::now()->format('Y-m-d'), 'workers' => [1]];
    }
    /**
     * @return array
     */
    ...
    {
        return ['application_id' => 1, 'onboarding_country_id' => 1, 'new_arrival_date' => Carbon::now()->addYear()->format('Y-m-d'), 'arrival_time' => '12:00', 'flight_number' => 'ASG74837498', 'remarks' => 'test', 'workers' => [1]];
    }
}
