...
class PostArrivalFomemaStatusUnitTest extends TestCase
{
    ...
    /**
     * Functional test for post arrival, FOMEMA total charge mandatory validation 
     * 
     * @return void
     */
    public function testForPostArrivalFOMEMATotalChargeRequiredValidation(): void
    {
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/fomema/purchase', array_merge($this->purchaseData(), ['fomema_total_charge' => '']), $this->getHeader());
        $response->seeStatusCode(422);
        $response->seeJson([
            'data' => [
                'fomema_total_charge' => ['The fomema total charge field is required.']
            ]
        ]);
    }
    /**
    ...
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/fomema/workersListExport', ['application_id' => 1, 'onboarding_country_id' => 1, 'search' => 'Wo'], $this->getHeader(false));
        $response->seeStatusCode(422);
        $response->seeJson([
            'data' => [
                'search' => ['The search must be at least 3 characters.']
    ...
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/fomema/workersListExport', ['application_id' => 1, 'onboarding_country_id' => 1, 'search' => ''], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' =>
                [
    ...
    /**
     * Functional test for plks show ID mandatory field validation
     * 
     * @return void
     */
    public function testForPLKSShowIdRequiredFieldValidation(): void
    {
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/fomema/plksShow', ['id' => ''], $this->getHeader());
        $response->seeStatusCode(422);
        $response->seeJson([
            'data' => [
    ...
    /**
     * Functional test for plks show
     * 
     * @return void
     */
    public function testForPLKSShow(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/fomema/plksShow', ['id' => 1], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' =>
                [
    ...
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/postArrival/fomema/updateSpecialPass', ['application_id' => 1, 'onboarding_country_id' => 1, 'workers' => [1]], $this->getHeader(false));
        $response->seeStatusCode(200);
        $response->seeJson([
