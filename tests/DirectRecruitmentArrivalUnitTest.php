...
class DirectRecruitmentArrivalUnitTest extends TestCase
{
    ...
    /*public function testForDirectRecruitmentArrivalWorkersListsubmit(): void
    {
        ...
        $response = $this->json('POST', 'directRecruitment/onboarding/arrival/workersListForSubmit', ["application_id" => 4,"onboarding_country_id" => 1,"search" => "","calling_visa_reference_number"=>""], $this->getHeader(false));
    ...
    /*public function testForDirectRecruitmentArrivalWorkersListUpdate(): void
    {
        $this->creationSeeder();
        $res = $this->json('POST', 'api/v1/directRecruitment/onboarding/arrival/submit', $this->creationData(), $this->getHeader(false));
        $response = $this->json('POST', 'directRecruitment/onboarding/arrival/workersListForUpdate', [
            "application_id"=> 4,
    ...
    /*public function testFortestForDirectRecruitmentArrivallist(): void
    {
        $this->creationSeeder();
        $res = $this->json('POST', 'api/v1/directRecruitment/onboarding/arrival/submit', $this->creationData(), $this->getHeader(false));
        $response = $this->json('POST', 'api/v1/directRecruitment/onboarding/arrival/lit', ['application_id' => 1, 'onboarding_country_id' => 1], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' =>
                [
