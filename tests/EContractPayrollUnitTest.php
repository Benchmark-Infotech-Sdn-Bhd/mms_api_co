...
class EContractPayrollUnitTest extends TestCase
{
    ...
    /**
     * Functional test for EContract payroll listing
     * 
     * @return void
     */
    public function testForeContractPayrollListing(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/eContract/payroll/list', ["project_id" => 1, "month"  => "", "year" => "", "search" => ""], $this->getHeader(false));
    ...
    /**
     * Functional test for EContract Payroll Export
     * 
     * @return void
     */
    public function testForeContractPayrollExport(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/eContract/payroll/export', ["project_id" => 1, "month"  => "", "year" => "", "search" => ""], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' => []
        ]);
    ...
    /**
     * Functional test for EContract Payroll View Timesheet
     * 
     * @return void
     */
    public function testForeContractPayrollViewTimesheet(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/eContract/payroll/viewTimesheet', ["project_id" => 1, "month"  => "", "year" => "", "search" => ""], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' => []
        ]);
    ...
    /**
     * Functional test for EContract Payroll Add
     * 
     * @return void
     */
    public function testForeContractPayrollAdd(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/eContract/payroll/add', $this->addData(), $this->getHeader(false));
        $response->seeStatusCode(200);
        $response->seeJson([
            'data' => ['message' => 'E-Contract Payroll Added Successfully']
        ]);
    }
    /**
     * Functional test for EContract Payroll Show
     * 
     * @return void
     */
    public function testForeContractPayrollShow(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/eContract/payroll/add', $this->addData(), $this->getHeader(false));
        $response = $this->json('POST', 'api/v1/eContract/payroll/show', ["id" => 1], $this->getHeader(false));
        $response->assertEquals(200, $this->response->status());
        $this->response->assertJsonStructure([
            'data' => []
        ]);
    ...
    /**
     * Functional test for EContract Payroll Update
     * 
     * @return void
     */
    public function testForeContractPayrollUpdate(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/eContract/payroll/add', $this->addData(), $this->getHeader(false));
        $response = $this->json('POST', 'api/v1/eContract/payroll/update', $this->updateData(), $this->getHeader(false));
        $response->seeStatusCode(200);
        $response->seeJson([
            'data' => ['message' => 'E-Contract Payroll Updated Successfully']
        ]);
    }
    /**
     ...
     * @return void
     */
    public function testForeContractPayrollUpdateIdValidation(): void
    {
        $this->creationSeeder();
        $response = $this->json('POST', 'api/v1/eContract/payroll/add', $this->addData(), $this->getHeader(false));
        $response = $this->json('POST', 'api/v1/eContract/payroll/update', array_merge($this->updateData(), ['id' => '']), $this->getHeader(false));
