...
class DirectRecruitmentExpenses extends Model implements Auditable
{
     ...
     * @var string
     */
    protected $table = 'directrecruitment_expenses';
    /**
     ...
     * @return HasMany
     */
    public function directRecruitmentExpensesAttachments()
    {
        return $this->hasMany(DirectRecruitmentExpensesAttachments::class, 'file_id');
    }
