...
class Workers extends Model implements Auditable
{
    ...
    'city','state', 'special_pass', 'special_pass_submission_date', 'special_pass_valid_until', 'plks_status', 'plks_expiry_date', 'total_management_flag', 'created_by','modified_by', 'crm_prospect_id', 'worker_status'];
