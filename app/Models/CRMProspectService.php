...
class CRMProspectService extends Model implements Auditable
{
     ...
     */
    protected $fillable = [
        'crm_prospect_id', 'service_id', 'service_name', 'sector_id', 'sector_name', 'contract_type', 'status', 'from_existing', 'client_quota', 'fomnext_quota', 'initial_quota', 'service_quota'
    ];
    /**
     * @return HasMany
     */
