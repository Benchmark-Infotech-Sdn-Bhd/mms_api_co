...
class DirectRecruitmentOnboardingCountryServices
{
    ...
    /**
     * List the on-boarding countries.
     *
     * @param array $request The request data to list the on-boarding countries.
     * - search_param (optional): The search parameter to filter the list. Must be a minimum of 3 characters and contain only letters and spaces.
     *
     * @return LengthAwarePaginator|array Returns an instance of LengthAwarePaginator.
     * The paginated list of on-boarding countries with the following keys:
     *  - id: The ID of the on-boarding country.
     *  - country: The name of the country.
     *  - system: The system type of the country.
     *  - quota: The quota of the on-boarding country.
     *  - utilised_quota: The utilised quota of the on-boarding country.
     *  - created_at: The creation date of the on-boarding country.
     *  - onboarding_status: The ID of the on-boarding status of the on-boarding country.
     *  - onboarding_status_name: The name of the on-boarding status of the on-boarding country.
     *
     * If the search parameter is provided and fails validation, an array with the following key will be returned:
     * - validate: The validation errors array.
     */
    ...
    public function create($request)
    {
        ...
        if ($applicationCheck->crm_prospect_id != $request[self::REQUEST_COMPANY_ID]) {
            return [
                'InvalidUser' => true
            ];
        }
    ...
    public function deleteKSM($request): bool|array
    {
        ...
        $this->saveOnboardingCountryDetails($ksmDetails);
        $ksmDetails->delete();
        return true;
    }

    /**
     * Add KSM Reference Number for Onboarding Countries
     *
     * @param array $request The request data to add KSM Reference Number.
     *  - application_id: The application ID for the country (optional, default: self::DEFAULT_INT_VALUE)
     *  - onboarding_country_id: The ID of the onboarding country
     *  - ksm_reference_number: The KSM reference number (optional, default: '')
     *  - quota: The quota value (optional, default: self::DEFAULT_INT_VALUE)
     *  - utilised_quota: The utilized quota value (optional, default: self::DEFAULT_INT_VALUE)
     *  - status: The status value (optional, default: self::STATUS_ACTIVE)
     *  - created_by: The created by value (optional, default: self::DEFAULT_INT_VALUE)
     *  - modified_by: The modified by value (optional, default: self::DEFAULT_INT_VALUE)
     *
     * @param object $checkCountry The object containing the country details to check.
     *
     * @return void
     */
    ...
    /**
     * Check for application in on-boarding country
     *
     * @param int $companyId The company ID to filter applications.
     * @param int $onboardingCoontryId The on-boarding country ID to check for application.
     *
     * @return mixed Returns null if no application is found or an instance of the on-boarding country model with the following attributes:
     *  - id
     *  - application_id
     *  - country_id
     *  - quota
     ...
     *  - deleted_at
     */
    private function checkForApplication(int $companyId, int $onboardingCoontryId): mixed
    {
        return $this->directRecruitmentOnboardingCountry
