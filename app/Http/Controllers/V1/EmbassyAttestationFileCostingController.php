...
class EmbassyAttestationFileCostingController extends Controller
{
    ...
    /**
     * Show the form for updating a EmbassyAttestationFileCostingServices.
     *
     * @param Request $request
     * @return JsonResponse
     */
    ...
    /**
     * Remove the specified EmbassyAttestationFileCostingServices.
     *
     * @param Request $request
     * @return JsonResponse
     */
    ...
    /**
     * Retrieve the specified EmbassyAttestationFileCostingServices based on Country.
     *
     * @param Request $request
     * @return JsonResponse
     */
