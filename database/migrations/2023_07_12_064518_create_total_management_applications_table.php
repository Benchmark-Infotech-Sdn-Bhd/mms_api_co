...
return new class extends Migration
{
    ...
    {
        Schema::create('total_management_applications', function (Blueprint $table) {
            // Id column for total management application
            $table->id();
    ...
    {
        Schema::dropIfExists('total_management_applications');
    }
};
