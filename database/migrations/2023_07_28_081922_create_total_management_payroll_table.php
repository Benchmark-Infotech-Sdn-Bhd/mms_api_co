...
return new class extends Migration
{
    ...
    {
        Schema::create('total_management_payroll', function (Blueprint $table) {
            // column for id
            $table->id();
            // column worker id
    ...
    {
        Schema::dropIfExists('total_management_payroll');
    }
};
