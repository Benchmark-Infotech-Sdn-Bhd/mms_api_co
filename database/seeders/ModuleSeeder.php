...
class ModuleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Module::create(['id' => 1, 'module_name' => 'Direct Recruitment', 'module_url' => '', 'parent_id' => 2, 'order_id' => 1, 'status' => 1]);
        Module::create(['id' => 1, 'module_name' => 'e-Contract', 'module_url' => '', 'parent_id' => 2, 'order_id' => 2, 'status' => 1]);
        Module::create(['id' => 1, 'module_name' => 'Total Management', 'module_url' => '', 'parent_id' => 2, 'order_id' => 3, 'status' => 1]);
    }
}